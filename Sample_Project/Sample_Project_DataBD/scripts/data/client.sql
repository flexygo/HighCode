...
USING (VALUES
  (1,N'FlexyGO',N'01977542W',N'+34 600 00 00',N'info@flexygo.es',N'C/ Ceramistes, 19',N'Alboraia',N'Valencia',N'46120',N'ES',1,2,N'~/custom/images/Client/flexygo.png',N'xdftddxgddxg','2019-03-14T00:00:00',0,0,'2019-02-13T12:33:00')
 ,(2,N'Imagination',NULL,N'+33 700 00 01',N'info@imagination.es',N'30 Rue de la Libertév',N'Carcassonne',N'Carcassonne',N'11000',N'FR',3,1,N'~/custom/images/Client/imagotipoahora.png',NULL,NULL,0,0,'2019-02-12T15:59:00')
 ,(4,N'Ahora Freeware',N'05664709Q',N'+34 601 601 601',N'info@freeware.es',N'Calle Amatista',N'Getafe',N'Madrid',N'28905',N'ES',1,2,N'~/custom/images/Client/ahora.png',N'xq si fafaf','2019-02-13T00:00:00',0,0,'2019-04-23T10:29:00')
 ,(5,N'LETRA PEQUEÑA SL',N'A0000000',N'669 001 001',N'info@LetraP.com',N'Paseo de la Habana 9-11',N'MADRID',N'MADRID',N'47092',N'ES',1,1,N'~/custom/images/Client/imagotipoflexygo.png',NULL,NULL,0,NULL,NULL)
 ,(6,N'RESOL GRUPO',N'A000000',N'972 000 000',N'resol@resol.es',N'Ctra. Alcañiz',N'teruel',N'TERUEL',N'44003',N'ES',1,1,N'~/custom/images/Client/flexygocampus.png',N'1','2019-02-13T00:00:00',1,0,'2019-02-13T17:45:00')
 ,(7,N'CATMAR NAUTICS SL',N'A00000000',N'972 600 600',N'catmar@catmarsn.es',N'Port Balis Local place 3',N'SANT ANDREU DE LLAVANERES',N'BARCELONA',N'08392',N'ES',1,1,N'~/custom/images/Client/ahora.png',NULL,NULL,0,NULL,NULL)
 ,(8,N'FIHOCA',N'AXXXXXX',N'932 222 222',N'fihoca@fihoca.com',N'Carrer de la Diputació, 237 ',N'BARCELONA',N'BARCELONA',N'00011',N'ES',1,1,N'~/custom/images/Client/flx_1.png',NULL,NULL,0,NULL,NULL)
 ,(9,N'EspacioDeInformatica',N'A0000000',N'902 000 111',N'espacio@info.es',N'C/San Francisco, 21 - 1ª Planta -Local C',N'TALAVERA DE LA REINA',N'TOLEDO',N'45600',N'ES',1,1,N'~/custom/images/Client/flexygo_1.png',NULL,NULL,0,NULL,NULL)
 ,(10,N'DOMHE',N'A000000',N'965 50 50 50',N'domhe@info.es',N'C/San Salvador, 34',N'MURO DE ALCOY',N'ALICANTE',N'03830',N'ES',1,1,N'~/custom/images/Client/logo_wfs_1.png',NULL,NULL,0,0,NULL)
 ,(12,N'Servicios EUSEBIO, SL',N'A000000',N'+34 618 300 600',N'eusebiorg@construcciones.es',N'La Malata, 78',N'FERROL',N'A CORUÑA',N'15315',N'ES',1,1,N'~/custom/images/Client/logo_wfs.png',NULL,NULL,0,NULL,NULL)
