...
USING (VALUES
  (N'Cliente_Offline',N'Combo cliente',N'dbcombo',NULL,N'select IdClient, Name, IdType, IdState from Client',N'select IdClient, Name, IdType, IdState from Client',N'Name like ''%{{FindString}}%'' or cast(IdClient as varchar) like ''%{{FindString}}%''',N'IdClient',N'Name',NULL,NULL,NULL,NULL,NULL,N'Client',1,1,NULL,0,0,0,NULL,N'Clientes',NULL,N'IdClient',N'Clientes',N'Cliente',NULL,N'IdClient',N'Cliente',N'Client.IdClient={{IdClient}}',N'popup',NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'<span class="{{IdState|switch:[2:text-muted,else:txt-outstanding]}}" >
	{{Name}} 
 ...
 ,(N'ComboIdEmployee_Offline',N'Combo Employees',N'dbcombo',NULL,N'Select Name, IdEmployee, Image from Employee order by Name',NULL,NULL,N'IdEmployee',N'Name',NULL,NULL,NULL,NULL,NULL,N'Employee',1,1,NULL,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'Employee',N'IdEmployee={{IdEmployee}}',N'popup',NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'<div class="row" style="display: flex;align-items: center; margin: 5px 15px;">
