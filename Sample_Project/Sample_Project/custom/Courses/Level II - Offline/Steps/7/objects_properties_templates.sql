...
USING (VALUES
  (N'Cliente_Offline',N'Combo cliente',N'dbcombo',NULL,N'select IdClient, Name, IdType, IdState from Client',N'select IdClient, Name, IdType, IdState from Client',N'Name like ''%{{FindString}}%'' or cast(IdClient as varchar) like ''%{{FindString}}%''',N'IdClient',N'Name',NULL,NULL,NULL,NULL,NULL,N'Client',1,1,NULL,0,0,0,NULL,N'Clientes',NULL,N'IdClient',N'Clientes',N'Cliente',NULL,N'IdClient',NULL,N'Cliente',N'Client.IdClient={{IdClient}}',N'popup',NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'<span class="{{IdState|switch:[2:text-muted,else:txt-outstanding]}}" >
	{{Name}} 
	<small>({{IdClient}})</small> 
	<i class="{{IdState|switch:[2:fa fa-lock txt-danger,else:fa fa-unlock text-muted]}}"></i>
</span>',NULL,NULL,N'DataConnectionString',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'|',NULL,NULL,NULL,NULL,1,2)
 ,(N'ComboIdEmployee_Offline',N'Combo Employees',N'dbcombo',NULL,N'Select Name, IdEmployee, Image from Employee order by Name',NULL,NULL,N'IdEmployee',N'Name',NULL,NULL,NULL,NULL,NULL,N'Employee',1,1,NULL,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'Employee',N'IdEmployee={{IdEmployee}}',N'popup',NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'<div class="row" style="display: flex;align-items: center; margin: 5px 15px;">
  <img class="img-responsive" style="width: 40px;margin-right: 10px;" src="{{Image|url}}" />
  <span>{{Name}}</span>
</div>',NULL,NULL,N'DataConnectionString',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'|',NULL,NULL,NULL,NULL,1,2)
