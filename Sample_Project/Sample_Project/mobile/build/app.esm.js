...
import './whiteboard-01f3e7c5.js';
import './parser-74bf7b6b.js';
...
const patchBrowser = () => {
    ...
    if (!BUILD.safari10 && importMeta !== '') {
        ...
        if (BUILD.dynamicImportShim && !win.customElements) {
            ...
            // @ts-ignore
            return import(/* webpackChunkName: "polyfills-dom" */ './dom-11a0ca56.js').then(() => opts);
        }
    }
