        ...
        _init: function () {
            ...
            me._createMarkup(),
                ...
                $(document).on("keyup.lobibox", function (ev) {
                    27 === ev.which || $(".lobibox-btn-default").hasClass("flxClicked")
                        ? me.destroy()
                        : 13 === ev.which && !1 == me.$options.multiline && $(".lobibox-btn-default").length > 0 && $(".lobibox-btn-default").addClass("flxClicked") && $(".lobibox-btn-default").click();
                }),
...
!(function () {
    ...
    var LobiboxBase = {
        ...
        _calculateHeight: function (height) {
            var me = this;
            return;
            (height = Math.min(Math.max(height, me.$options.height), $(window).outerHeight())), height === $(window).outerHeight() && (height -= 2 * me.$options.verticalOffset), height;
        },
        _addCloseButton: function () {
            var me = this,
                closeBtn = $('<span class="btn-close">&times;</span>');
