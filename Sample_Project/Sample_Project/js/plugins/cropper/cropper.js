...
(function (global, factory) {
    ...
    var render$1 = {
        ...
        initCanvas: function initCanvas() {
            ...
            var canvasWidth = options.initCanvasWidth ? options.initCanvasWidth : containerWidth;
            var canvasHeight = options.initCanvasHeight ? options.initCanvasHeight : containerHeight;
        ...
        limitCropBox: function limitCropBox(isSizeLimited, isPositionLimited) {
            ...
            if (isSizeLimited) {
                ...
                var maxCropBoxWidth = Number(options.maxCropBoxWidth) || Math.min(containerWidth, limited ? canvas.width : containerWidth);
                var maxCropBoxHeight = Number(options.maxCropBoxHeight) || Math.min(containerHeight, limited ? canvas.height : containerHeight);
