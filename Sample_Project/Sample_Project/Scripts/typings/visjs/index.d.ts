...
//import { MomentInput, MomentFormatSpecification, Moment } from '..\moment\moment.d.ts';
...
export class Network {
     ...
     */
    getConnectedNodes(nodeOrEdgeId: IdType, direction?: 'from'|'to'): IdType[] | Array<{ fromId: IdType, toId: IdType }>;
...
export interface Node {
    ...
    //Flexygo own properties

    objectexpanded?: boolean;
    objectname?: string;
    objectwhere?: string;
