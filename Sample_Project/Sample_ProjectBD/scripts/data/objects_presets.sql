...
USING (VALUES
  (N'ClientesActivos',N'Cliente',N'Clientes activos',N'(Client.IdState=1)',N'fa-unlock',NULL,NULL,0,0,1)
 ,(N'ClientesBloqueados',N'Cliente',N'Clientes bloqueados',N'(Client.IdState=2)',N'fa-lock',NULL,NULL,0,0,1)
