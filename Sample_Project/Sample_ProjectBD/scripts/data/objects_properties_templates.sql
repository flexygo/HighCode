...
USING (VALUES
  (N'CBO_Country',N'Countries',N'dbcombo',NULL,N'select IsoCode, Name, Flag from Countries order by Name',N'select IsoCode, Name, Flag from Countries order by Name',N'Name like ''%{{FindString}}%''',N'IsoCode',N'Name',NULL,NULL,NULL,N'Country',1,1,NULL,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'popup',NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'<div><span class="{{Flag}}"></span> {{Name}}</div>',NULL,NULL,N'DataConnectionString',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'|',NULL,NULL,NULL,NULL,0,1)
 ,(N'Cliente',N'Combo cliente',N'dbcombo',NULL,N'select IdClient, Name, IdType, IdState from Client',N'select IdClient, Name, IdType, IdState from Client',N'Name like ''%{{FindString}}%'' or cast(IdClient as varchar) like ''%{{FindString}}%''',N'IdClient',N'Name',NULL,NULL,NULL,N'Client',1,1,NULL,0,0,0,NULL,N'Clientes',NULL,N'IdClient',N'Clientes',N'Cliente',NULL,N'IdClient',N'Cliente',N'Client.IdClient={{IdClient}}',N'popup',NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'<span class="{{IdState|switch:[2:text-muted,else:txt-outstanding]}}" >
	{{Name}} 
 ...
 ,(N'Combo_Courses',N'Combo Courses',N'dbcombo',NULL,N'Select CourseId,Course From Courses Order By Course',NULL,N'(Course like ''%{{FindString}}%'')',N'CourseId',N'Course',NULL,NULL,NULL,N'Courses',1,1,NULL,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'popup',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'DataConnectionString',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'|',NULL,NULL,NULL,NULL,0,1)
 ,(N'ComboIdEmployee',N'Combo Employees',N'dbcombo',NULL,N'Select Name, IdEmployee, Image from Employee order by Name',NULL,NULL,N'IdEmployee',N'Name',NULL,NULL,NULL,N'Employee',1,1,NULL,0,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'Employee',N'IdEmployee={{IdEmployee}}',N'popup',NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'<div class="row" style="display: flex;align-items: center; margin: 5px 15px;">
