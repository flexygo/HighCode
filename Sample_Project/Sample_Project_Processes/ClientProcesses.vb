...
Public Class ClientProcesses
    ...
    Public Shared Function InsertClient(Entity As EntityObject, Ret As ProcessHelper) As Boolean
        Try
    ...
    ''' <param name="Entity">User Entity object with all info</param>
    ''' <param name="Ret">ProcessHelper for returning results</param>
    Public Shared Function UpdateClient(Entity As EntityObject, Ret As ProcessHelper) As Boolean
        Try
    ...
    ''' <param name="Entity">User Entity object with all info</param>
    ''' <param name="Ret">ProcessHelper for returning results</param>
    Public Shared Function DeleteClient(Entity As EntityObject, Ret As ProcessHelper) As Boolean
        Try
